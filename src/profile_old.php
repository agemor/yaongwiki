  ...
  echo "<div class=\"alert alert-danger\" role=\"alert\">".$error_message."</div>";
			...
			echo '<input type="hidden" name="user-name" value="'.$target_user_name.'">
  	        ...
  	        <div style="margin-bottom: 10px" class="input-group">
  	         ...
  	         <button style="margin-bottom: 10px" class="btn btn-default btn-block" type="button" data-toggle="collapse" data-target="#authorize" aria-expanded="false" aria-controls="authorize">
			  재학생 인증
			</button>

			<div class="collapse" id="authorize">
			    <label for="user-password">학번과 비밀번호는 인증 목적 외로는 일체 사용되거나 저장되지 않습니다.</label>	
	  	        <div style="margin-bottom: 10px" class="input-group">
	  	          <span class="input-group-addon"><i class="glyphicon glyphicon-lock"></i></span>
	  	          <input type="password" id="user-password" name="user-new-password" class="form-control" placeholder="학번">
	  	        </div>
	  	        <div style="margin-bottom: 20px" class="input-group">
	  	          <span class="input-group-addon"><i class="glyphicon glyphicon-lock"></i></span>
	  	          <input type="password" id="user-password-re" name="user-new-password-re" class="form-control" placeholder="비밀번호">
	  	        </div>
			</div>

  	        <button style="margin-bottom: 10px" class="btn btn-default btn-block" type="button" data-toggle="collapse" data-target="#passwordChange" aria-expanded="false" aria-controls="passwordChange">
			  비밀번호 변경
			</button>
