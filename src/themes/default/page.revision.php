...
$page["title"] = $page["revision"]["article_title"] . " (Revision " .$page["revision"]["revision"]. ")" . " - " . SettingsManager::get_instance()->get("site_title");
?>
...
<div class="container">
  ...
  <div class="text-right mb-3">
    <div class="btn-group" role="group">
      ...
      <a class="btn btn-default" href="./?revision&i=<?php echo($page['revision']['id']);?>&rollback=true">Rollback</a>
