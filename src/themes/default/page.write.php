...
require_once YAONGWIKI_CORE_DIR . "/page.write.processor.php";
...
<div class="container">
  ...
  <form action="./?write" method="post" name="form">
    ...
    <?php if ($have_permission && $user_permission >= PERMISSION_DELETE_ARTICLE) { ?>
